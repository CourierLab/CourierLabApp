...
export default class AddOrder extends Component{
    ...
    openImage2(){
        ...
        console.log('image: ', this.state.orderImage2)
    }
    ...
    async addOrder(){
        ...
        //     Alert.alert('Cannot Add', "Please key in Pick Up Location, Pick Up Date, Expected Arrival Date, Recipient Name, Recipient Address, Recipient Email, Recipient Phone Number, Lorry Type, No. of Manpower, No. of trolley, Order Weight(kg), Order Description, Vechicle Specification and Shipper Order Images", [{
