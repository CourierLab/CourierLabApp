...
export default class ConfirmedOrderDetail extends Component{
    static navigationOptions = {
        ...
        headerRight: (
            <MaterialComIcon onPress={() => { _this.getCode() }} name={'qrcode'} size={25} color={'#fff'} style={{paddingRight: 20,}}/>
        ),
    };
            ...
            <ScrollView style={styles.scrollViewContainer}>
                {
                    ...
                    {(this.state.orderSummary.currentTrackingStatus === "Processing") ? <Card 
                        ...
                        containerStyle={{margin: 15, borderRadius: 20, shadowOpacity: 1, backgroundColor: '#EFEFEF', shadowColor: '#e0e0e0', shadowRadius: 3, shadowOffset: {width: 1, height: 1,},}}>
                                    ...
                                    <View style={{paddingTop: 10, paddingBottom: 10, paddingLeft: 0, paddingRight: 0, flexDirection: 'column', backgroundColor: '#EFEFEF',}}>
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            ...
                                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                                <Text style={{fontSize: 14, color: '#9B9B9B', fontFamily: 'AvenirLTStd-Medium', }}>Payment Status</Text>
                                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.orderSummary.shipperOrder.paymentStatus}</Text>
                                            </View>
                                        </View>
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            <View style={{flexDirection: 'column', justifyContent: 'center',}}>
                                        ...
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            ...
                                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                                ...
                                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.orderSummary.shipperOrder.price}</Text>
                                            </View>
                                        </View>
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            <View style={{flexDirection: 'column', justifyContent: 'center',}}>
                                    ...
                                    {(!this.state.orderSummary.shipperOrder.showPayButton) ? <View>
                                        ...
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            ...
                                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                                ...
                                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.orderSummary.driverOrder.driverName}</Text>
                                            </View>
                                        </View>
                                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                                            <View style={{flexDirection: 'column', justifyContent: 'center',}}>
                                            ...
                                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                                ...
                                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.orderSummary.driverOrder.driverPhoneNumber}</Text>
                                            </View>
                                        </View>
                                    </View> : <View/>}
                            ...
                            {
                                (this.state.orderSummary.shipperOrder.showPayButton) ? 
                                <View style={this.state.isSubmit ? {backgroundColor: '#F4D549', borderRadius: 20, paddingLeft: 10, paddingRight: 10, marginLeft: 10, marginRight: 10, marginBottom: 10, marginTop: 20,} : {backgroundColor: '#2C2E6D', borderRadius: 20, paddingLeft: 10, paddingRight: 10, marginLeft: 10, marginRight: 10, marginBottom: 10, marginTop: 20,}}>
                                    <TouchableOpacity
                                        disabled={this.state.isSubmit}
                                        style={this.state.isSubmit ? {backgroundColor: '#F4D549', borderRadius: 20, paddingVertical: 15,} : styles.buttonContainer}
                                        onPress={() => {
                                            this.props.navigation.navigate('PendingPaymentDetail', {
                                                matchedOrderId: this.state.orderSummary.matchedOrderId,
                                                rerenderFunction : () => this.getOrderSummary()
                                            })
                                        }}>
                                        <Text style={this.state.isSubmit ? {color: '#2C2E6D', textAlign: 'center', fontSize: 16, fontFamily: 'AvenirLTStd-Black',} : {color: '#fff', textAlign: 'center', fontSize: 16, fontFamily: 'AvenirLTStd-Black',}}>Pay</Text>
                                    </TouchableOpacity>
                                </View>
                                // <View style={{backgroundColor: '#fff', paddingLeft: 10, paddingRight: 10, marginLeft: 20, marginRight: 20, marginBottom: 40, paddingTop: 20,}}>
                                //     <TouchableOpacity
                                //         disabled={this.state.isSubmit}
