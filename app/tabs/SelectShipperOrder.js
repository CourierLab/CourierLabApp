        ...
        .then((json) => {
            ...
            if(json.succeeded){
                this.setState({
                    ...
                    shipperDeliveryDistance: json.results.shipperDeliveryDistance,
                    spinnerVisible: false,
                })
            }else{
    ...
    render(){
        ...
        return (
            <ScrollView style={styles.scrollViewContainer}
                ...
                {(this.state.driverDetails !== [] && !this.state.spinnerVisible) ? <Card title={'Driver Order Details'} titleStyle={{fontFamily: 'AvenirLTStd-Black', fontSize: 16, color: '#2C2E6D',}} containerStyle={{margin: 15, borderRadius: 20, shadowOpacity: 1, backgroundColor: '#EFEFEF', shadowColor: '#e0e0e0', shadowRadius: 3, shadowOffset: {width: 1, height: 1,},}}>
                ...
                {(this.state.shipperDetails !== [] && !this.state.spinnerVisible) ? <View style={{marginBottom: 20,}}> 
                    ...
                    <View style={{paddingTop: 10, paddingBottom: 10, paddingLeft: 0, paddingRight: 0, flexDirection: 'column', backgroundColor: '#EFEFEF',}}>
                        ...
                        <View style={{flexDirection: 'column',}}>
                            ...
                            <Text style={{paddingLeft: 5, paddingTop: 0, paddingBottom: 10, paddingRight: 5, color: '#3c4c96', fontSize: 18,}}>{this.state.shipperDeliveryDistance}</Text>
                        </View>
                        <View style={{flexDirection: 'column',}}>
