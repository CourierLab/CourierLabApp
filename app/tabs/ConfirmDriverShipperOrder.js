...
export default class ConfirmDriverShipperOrder extends Component{
    ...
    componentDidMount() {
        ...
        this.setState({
            driverDetails: this.props.navigation.getParam('orderConfirmationDetails').driverOrder,
            shipperDetails: this.props.navigation.getParam('orderConfirmationDetails').shipperOrder,
        })
    }
    ...
    render(){
        ...
        return (
            <ScrollView style={styles.scrollViewContainer}
                ...
                {(this.state.driverDetails !== []) ? <Card title={'Driver Order Details'} titleStyle={{fontFamily: 'AvenirLTStd-Black', fontSize: 16, color: '#2C2E6D',}} containerStyle={{margin: 15, borderRadius: 20, shadowOpacity: 1, backgroundColor: '#EFEFEF', shadowColor: '#e0e0e0', shadowRadius: 3, shadowOffset: {width: 1, height: 1,},}}>
                ...
                {(this.state.shipperDetails !== []) ? <View style={{marginBottom: 20,}}> 
                    <Card title={(
                            <View style={{flexDirection: 'column',}}>
                    ...
                    <View style={{paddingTop: 10, paddingBottom: 10, paddingLeft: 0, paddingRight: 0, flexDirection: 'column', backgroundColor: '#EFEFEF',}}>
                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                            ...
                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                ...
                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.shipperDetails.shipperName}</Text>
                            </View>
                        </View>
                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                            <View style={{flexDirection: 'column', justifyContent: 'center',}}>
                            ...
                            <View style={{flexDirection: 'column', paddingRight: 20,}}>
                                ...
                                <Text style={{fontSize: 16, color: '#2C2E6D', fontFamily: 'AvenirLTStd-Heavy', }}>{this.state.shipperDetails.shipperPhoneNumber}</Text>
                            </View>
                        </View>
                        <View style={{flexDirection: 'row', paddingBottom: 10, paddingRight: 10,}}>
                            <View style={{flexDirection: 'column', justifyContent: 'center',}}>
                        ...
                        <View style={{flexDirection: 'column',}}>
                            ...
                            <Text style={{paddingLeft: 5, paddingTop: 0, paddingBottom: 10, paddingRight: 5, color: '#3c4c96', fontSize: 18,}}>{this.props.navigation.getParam('orderConfirmationDetails').shipperDeliveryDistance}</Text>
                        </View>
                        <View style={{flexDirection: 'column',}}>
                ...
                <View style={this.state.isSubmit ? {backgroundColor: '#F4D549', borderRadius: 20, paddingLeft: 10, paddingRight: 10, marginLeft: 10, marginRight: 10, marginBottom: 10, marginTop: 0,} : {backgroundColor: '#2C2E6D', borderRadius: 20, paddingLeft: 10, paddingRight: 10, marginLeft: 10, marginRight: 10, marginBottom: 10, marginTop: 0,}}>
                    <TouchableOpacity
                        ...
                        <Text style={this.state.isSubmit ? {color: '#2C2E6D', textAlign: 'center', fontSize: 16, fontFamily: 'AvenirLTStd-Black',} : {color: '#fff', textAlign: 'center', fontSize: 16, fontFamily: 'AvenirLTStd-Black',}}>Confirm</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        )
